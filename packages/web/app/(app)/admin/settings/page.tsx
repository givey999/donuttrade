        ...
        <Card className="mt-4 p-5">
          ...
          <div className="mt-3 flex items-center gap-3">
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                maintenanceEnabled ? 'bg-violet-600' : 'bg-neutral-700'
              }`}
            >
              <span
          ...
          <div className="mt-3">
            ...
            <textarea
              ...
              rows={3}
              className="mt-1 w-full rounded-lg border border-[#1a1a1a] bg-white/[0.03] px-3 py-2 text-sm text-white placeholder-neutral-600 transition-colors focus:border-violet-600/50 focus:outline-none focus:ring-1 focus:ring-violet-600/30"
