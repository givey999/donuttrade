        ...
        <Card className="mt-6 p-6">
          ...
          <div className="mt-4">
            ...
            {pricePerUnit && price > 0 && /[a-zA-Z]/.test(pricePerUnit) && (
              <p className="mt-1 text-xs text-violet-600/80">${price.toLocaleString()}</p>
            )}
              ...
              <div className="mt-1.5 flex flex-wrap gap-2">
                <button
                  ...
                  className={`h-7 w-7 rounded-full border-2 transition-all ${
                    !borderColor ? 'border-violet-600 ring-2 ring-violet-600/30' : 'border-[#1a1a1a]'
                  } bg-[#1a1a1a]`}
                  title="None"
                />
            ...
            <div className="mt-4">
              ...
              <div className="mt-1.5 flex flex-wrap gap-2">
                <button
                  ...
                  className={`h-7 w-7 rounded-full border-2 transition-all ${
                    !usernameColor ? 'border-violet-600 ring-2 ring-violet-600/30' : 'border-[#1a1a1a]'
                  } bg-[#1a1a1a]`}
                  title="None"
                />
                {unlockedColors.map((color) => (
              ...
              <div className="space-y-1">
                ...
                {type === 'sell' && (
                  <div className="flex justify-between border-t border-[#1a1a1a] pt-1 font-medium">
                    ...
                    <span className="text-violet-500">{qty}x {selectedItem?.displayName}</span>
                  </div>
                )}
              </div>
            </div>
