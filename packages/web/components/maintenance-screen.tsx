  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-4">
      <div className="mx-auto w-full max-w-md rounded-2xl border border-[#1a1a1a] bg-[#111] p-8 text-center shadow-2xl">
        {/* Icon */}
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-violet-600/10">
        ...
        {message && (
          <div className="mt-4 rounded-lg border border-violet-600/20 bg-violet-600/[0.05] px-4 py-3">
            <p className="text-xs font-medium uppercase tracking-wider text-violet-600/70">Reason</p>
